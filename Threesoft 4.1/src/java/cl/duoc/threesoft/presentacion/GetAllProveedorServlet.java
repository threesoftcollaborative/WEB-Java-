 ...
 * @author Max
 */
@WebServlet(name = "GetAllProveedorServlet", urlPatterns = {"/getallproveedor"})
public class GetAllProveedorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<SgaProveedor> proveedorList = this.proveedorDAOSessionBean.proveedorListById(almacen_id);
        session.setAttribute("proveedorList", proveedorList);
